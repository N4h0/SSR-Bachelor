...
const ContactInfo = ({ t }) => (
  <div className={styles.kontaktinfo}>
    ...
    <div>
      ...
      <span className={styles.link}>Vollaveien 20 A, 0668 Oslo</span>
    </div>
    <div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      <a className={styles.link} href="tel:4740056898">+47-400-56-898</a>
    </div>
    <div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      <a className={styles.link} href="mailto:mn@mnregnskap.no">mn@mnregnskap.no</a>
    </div>
  </div>
);
